...
class _ManageProductsState extends State<ManageProducts> {
  ...
  Future<void> _editProduct(
    ...
    final categoryIdController = TextEditingController(text: productData['CategoryId']);
              ...
              : () async {
                  ...
                  try {
                    ...
                    Get.snackbar(
                      ...
                      messageText: const Text('Product updated successfully!', style: TextStyle(color: Colors.white),)
                    );
                    Navigator.of(context).pop(); // Close the dialog
                  } catch (error) {
                    Get.snackbar(
                      ...
                      messageText: Text('Failed to update product: $error', style: const TextStyle(color: Colors.white),)
                    );
                  } finally {
                    setState(() {
